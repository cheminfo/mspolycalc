...
define(['src/util/api'], function (API) {
  ...
  function _exercisesManager() {
    _exercisesManager = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(action, allExercises, options) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              loadExercises = function _ref3(allExercises) {
              ...
              saveState = function _ref2(cookieName, state) {
                window.localStorage.setItem(cookieName, JSON.stringify(state));
              };

              loadState = function _ref(cookieName) {
