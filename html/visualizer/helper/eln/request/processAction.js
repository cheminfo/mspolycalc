...
define(["exports", "src/util/api", "src/util/ui", "./Status"], function (exports, _api, _ui, _Status) {
  ...
  function _bulkChangeStatus() {
    _bulkChangeStatus = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(selected) {
      var newStatus, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, requestToc, request;
      ...
      return regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 2:
              _context7.t0 = function (g) {
                return g.name;
              };

              groups = _context7.sent.map(_context7.t0);
