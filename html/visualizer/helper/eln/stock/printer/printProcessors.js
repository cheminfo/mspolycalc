...
define(['src/main/datas', 'src/util/ui', 'browserified/twig/twig', 'canvg', '../../libs/Image', '../../libs/OCLE'], function (Datas, UI, _twig, canvg, IJS, OCL) {
  ...
  return {
    twig: function () {
      var _twig2 = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(printFormat, data, options) {
  ...
  function _enhanceZebraFormat() {
    _enhanceZebraFormat = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee2(printFormat, text, data) {
  ...
  function _enhanceCognitiveFormat() {
    _enhanceCognitiveFormat = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee3(printFormat, text, data) {
      var encoder, mol, end;
  ...
  function _getMolImage() {
    _getMolImage = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee4(molfile) {
      var options,
          defaultMolOptions,
          renderingScale,
          mol,
  ...
  function _getMolBmp() {
    _getMolBmp = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee5(molfile, options) {
      var mask, bmp;
