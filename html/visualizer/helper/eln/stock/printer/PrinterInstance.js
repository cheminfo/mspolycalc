...
define(['src/util/util', './printServerFactory', './printProcessors'], function (Util, printServerFactory, processors) {
  var Printer =
  /*#__PURE__*/
  function () {
    ...
    _createClass(Printer, [{
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee(printFormat, data) {
          var printData;
  ...
  function _getPrintData() {
    _getPrintData = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee2(printFormat, data) {
      var options,
          _args2 = arguments;
