...
define(["module", "openchemlib/openchemlib-core"], function (module, _openchemlibCore) {
  ...
  function Structure(roc) {
    return {
      refresh: function () {
        var _refresh = _asyncToGenerator(regeneratorRuntime.mark(function _callee(type) {
          var options;
      ...
      create: function () {
        var _create = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(molfile, type) {
          var ocl;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  return _context2.abrupt("return", this._createFromOcl(ocl, type));
      ...
      _createFromOcl: function () {
        var _createFromOcl2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(ocl, type, rocOptions) {
          var prefix, newEntry;
        ...
        function _createFromOcl(_x4, _x5, _x6) {
          return _createFromOcl2.apply(this, arguments);
        }

        return _createFromOcl;
      }(),
      createAndGetId: function () {
        var _createAndGetId = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(molfile, type) {
        ...
        function createAndGetId(_x7, _x8) {
          return _createAndGetId.apply(this, arguments);
        }
  ...
  function getNextId(_x9, _x10, _x11) {
